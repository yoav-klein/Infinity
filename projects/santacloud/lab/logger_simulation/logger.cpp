...
{
	Logger logger;
	logger.write(Logger::ERROR, std::string(YELLOW) + "main" + std::string(RESET), "Hello", __LINE__);
	logger.write(Logger::ERROR, RED "NBDDriver" RESET, "Hello", __LINE__);
	logger.write(Logger::ERROR, ORANGE "RAMStorage" RESET, "Hello", __LINE__);
